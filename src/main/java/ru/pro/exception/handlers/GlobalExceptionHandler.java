...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidJson(MethodArgumentTypeMismatchException ex) {
        Throwable rootCause = ex.getMostSpecificCause();
        String message = rootCause.getMessage();
        return handleWalletError(BAD_REQUEST, "INVALID_UUID", message, ex);
    }
